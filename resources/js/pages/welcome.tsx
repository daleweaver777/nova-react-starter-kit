            ...
            <div className="flex min-h-svh flex-col items-center bg-background p-6 text-foreground lg:justify-center lg:p-8">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-xl rounded-bl-xl border border-border bg-card p-6 pb-12 text-sm text-card-foreground lg:rounded-tl-xl lg:rounded-br-none lg:p-20">
                            <h1 className="mb-1 font-heading text-lg font-semibold">
                                Let's get started
                            </h1>
                            ...
                            <ul className="mb-4 flex flex-col lg:mb-6">
                                <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-border">
                                    <span className="relative bg-card py-1">
                                        <span className="flex size-3.5 items-center justify-center rounded-full border border-border bg-background">
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-xl bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-xl dark:bg-[#1D0002]">
                            ...
                            >
                                ...
                                />
                                <path
                                    d="M110.26 41.63C108.06 38.13 104.94 35.37 100.91 33.37C96.87 31.36 92.8 30.36 88.71 30.36C83.42 30.36 78.59 31.34 74.2 33.29C69.81 35.25 66.05 37.93 62.91 41.33C59.76 44.74 57.32 48.67 55.58 53.13C53.83 57.59 52.96 62.27 52.96 67.18C52.96 72.19 53.83 76.9 55.58 81.31C57.32 85.72 59.76 89.62 62.91 93.03C66.05 96.44 69.81 99.12 74.2 101.07C78.59 103.02 83.42 104 88.71 104C92.8 104 96.87 103 100.91 100.99C104.94 98.99 108.06 96.24 110.26 92.73V102.19H126.56V32.16H110.26V41.63ZM108.76 75.75C107.76 78.45 106.37 80.81 104.57 82.81C102.78 84.82 100.61 86.42 98.06 87.62C95.52 88.82 92.7 89.42 89.61 89.42C86.52 89.42 83.73 88.82 81.23 87.62C78.74 86.42 76.59 84.82 74.8 82.81C73 80.81 71.63 78.45 70.69 75.75C69.74 73.04 69.26 70.19 69.26 67.18C69.26 64.18 69.74 61.32 70.69 58.62C71.63 55.91 73 53.56 74.8 51.55C76.59 49.55 78.74 47.95 81.23 46.74C83.73 45.54 86.52 44.94 89.61 44.94C92.7 44.94 95.52 45.54 98.06 46.74C100.61 47.95 102.78 49.55 104.57 51.55C106.37 53.56 107.76 55.91 108.76 58.62C109.76 61.32 110.26 64.18 110.26 67.18C110.26 70.19 109.76 73.04 108.76 75.75Z"
                                    fill="currentColor"
                                />
                                <path
                                    d="M242.81 41.63C240.61 38.13 237.49 35.37 233.46 33.37C229.42 31.36 225.35 30.36 221.26 30.36C215.97 30.36 211.14 31.34 206.75 33.29C202.36 35.25 198.6 37.93 195.46 41.33C192.31 44.74 189.87 48.67 188.12 53.13C186.38 57.59 185.51 62.27 185.51 67.18C185.51 72.19 186.38 76.9 188.12 81.31C189.87 85.72 192.31 89.62 195.46 93.03C198.6 96.44 202.36 99.12 206.75 101.07C211.14 103.02 215.97 104 221.26 104C225.35 104 229.42 103 233.46 100.99C237.49 98.99 240.61 96.24 242.81 92.73V102.19H259.11V32.16H242.81V41.63ZM241.31 75.75C240.31 78.45 238.92 80.81 237.12 82.81C235.33 84.82 233.16 86.42 230.61 87.62C228.07 88.82 225.25 89.42 222.16 89.42C219.07 89.42 216.28 88.82 213.78 87.62C211.29 86.42 209.15 84.82 207.35 82.81C205.55 80.81 204.18 78.45 203.24 75.75C202.29 73.04 201.81 70.19 201.81 67.18C201.81 64.18 202.29 61.32 203.24 58.62C204.18 55.91 205.55 53.56 207.35 51.55C209.15 49.55 211.29 47.95 213.78 46.74C216.28 45.54 219.07 44.94 222.16 44.94C225.25 44.94 228.07 45.54 230.61 46.74C233.16 47.95 235.33 49.55 237.12 51.55C238.92 53.56 240.31 55.91 241.31 58.62C242.31 61.32 242.81 64.18 242.81 67.18C242.81 70.19 242.31 73.04 241.31 75.75Z"
                                    fill="currentColor"
                                />
                                <path
                                ...
                                />
                                <path
                                    d="M376.57 30.37C356.6 30.37 340.8 46.85 340.8 67.18C340.8 89.66 356.09 104 378.66 104C391.29 104 399.35 99.15 409.21 88.58L398.19 80.02C398.18 80.03 389.87 90.99 377.47 90.99C363.05 90.99 356.98 79.31 356.98 73.27H411.07C413.92 50.13 398.77 30.37 376.57 30.37ZM357.02 61.1C357.14 59.75 359.02 43.38 376.44 43.38C393.86 43.38 395.98 59.75 396.1 61.1H357.02Z"
                                    fill="currentColor"
                                />
                            </svg>
                            ...
                            <div className="absolute inset-0 rounded-t-xl border border-border lg:rounded-t-none lg:rounded-r-xl"></div>
                        </div>
                    </main>
                </div>
